...
export default function Page() {
    ...
    return <div className="w-full max-w-[1536px] mx-auto p-4">
        <form action={formAction} className="sm:ps-12 mt-8 flex flex-col items-start w-full">
            ...
            <input autoFocus required className="text-primary text-lg bg-transparent border border-b-lime-400 border-x-transparent border-t-transparent mt-10" placeholder="Title" name="title" />
            {album?.selectedPhotosForAlbum.length > 0 ? <>
                ...
                <div className="flex flex-col mt-12 animate-fade-in-down">
                    <div className="flex w-full max-w-full">
                        <p className="text-lg text-primary">Privacy: </p>
                        <div className="ps-8">
                            ...
                            <label for="private" className="text-primary text-lg ms-2 cursor-pointer bg-lime-400 bg-opacity-10 px-3 py-2 rounded-md peer-checked:border-lime-400 peer-checked:bg-opacity-15 peer-checked:border transition-all duration-300">Private</label>
                        </div>
                        <div className="ps-8">
                            ...
                            <label for="shared" className="text-primary text-lg ms-2 cursor-pointer bg-lime-400 bg-opacity-10 px-3 py-2 rounded-md peer-checked:border-lime-400 peer-checked:bg-opacity-15 peer-checked:border transition-all duration-300">Shared</label>
                        </div>
                        <div className="ps-8">
                            ...
                            <label for="public" className="text-primary text-lg ms-2 cursor-pointer bg-lime-400 bg-opacity-10 px-3 py-2 rounded-md peer-checked:border-lime-400 peer-checked:bg-opacity-15 peer-checked:border transition-all duration-300">Public</label>
                        </div>
                    </div>
                    {(privacy === "shared" || privacy === "public") && <div className="flex flex-col w-full max-w-full animate-fade-in-down">
                        {privacy === "shared" && <div className="w-full flex animate-fade-in-down">
                            <textarea required multiple className="text-primary text-md bg-transparent border border-b-lime-400 border-x-transparent border-t-transparent mt-10 w-full" rows={3} placeholder="Enter email addresses (one per line)" name="emails[]" />
                        </div>}
                        <div className="w-full flex mt-10">
                            <p className="text-lg text-primary">Accessibility: </p>
                            <div className="ps-8">
                                ...
                                <label for="view-only" className="text-primary text-lg ms-2 cursor-pointer bg-lime-400 bg-opacity-10 px-3 py-2 rounded-md peer-checked:border-lime-400 peer-checked:bg-opacity-15 peer-checked:border transition-all duration-300">View Only</label>
                            </div>
                            {privacy === "shared" && <div className="ps-8">
                                ...
                                <label for="add-images" className="text-primary text-lg ms-2 cursor-pointer bg-lime-400 bg-opacity-10 px-3 py-2 rounded-md peer-checked:border-lime-400 peer-checked:bg-opacity-15 peer-checked:border transition-all duration-300">Add Images</label>
                            </div>}
                        </div>
                    </div>}
                </div>
                <div className="mt-12 animate-fade-in-down">
                    <SubmitButton content={"Create album"} className="w-full text-center bg-lime-400 bg-opacity-10 hover:bg-opacity-15 transition-all ease-in-out duration-200 rounded-md border-lime-500/100 border py-2 text-primary sm:order-2 order-1 px-3 text-lg" />
                </div>
