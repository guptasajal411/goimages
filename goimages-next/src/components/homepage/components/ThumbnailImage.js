...
export default function ThumbnailImage({ src, key, width, height, id, favourite, addToSelected, removeFromSelected, isSelected }) {
    ...
    return <div className="relative thumbnailContainer">
        ...
        <button onClick={() => isSelected ? removeFromSelected(id) : addToSelected(id)} className={`absolute selectIcon ${isSelected && "isSelected"}`} >
